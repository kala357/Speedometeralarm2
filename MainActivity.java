...
public class MainActivity extends Activity implements LocationListener,
    ...
    public void onLocationChanged(Location location) {
        ...
        EditText lower = (EditText) findViewById(R.id.Lowerlimit) ;
        int lowerval = Integer.parseInt( lower.getText().toString() );
        EditText upper = (EditText) findViewById(R.id.Upperlimit) ;
        int upperval = Integer.parseInt( upper.getText().toString() );
        ...
        if (this.started) {
            ...
            if (location == null) {
                ...
                txt.setText(String.format("%.2f", x_s) + " Km/hr");
                long timestamp = System.currentTimeMillis();

                SpeedData data = new SpeedData(timestamp, x_s);

                this.x.add(data);
                if (x_s < lowerval || x_s > upperval){
                //alarm
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnStart:
                ...
                this.x.add(data);
                Log.v("inserting new data", data.toString());
